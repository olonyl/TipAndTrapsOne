...
namespace CompilerInferredGenericMethodtypes
{
    ...
    public class WorkingWithUris
    {
        ...
        public void CreatingRelativeAndAbsolute()
        {
            ...
            dct = new Uri("http://dontcodetire.com", UriKind.Absolute);//this is the same above
        ...
        {
            var dct = new Uri("http://dontcodetired.com:8080/blog/");
