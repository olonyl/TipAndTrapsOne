...
{
    [TestClass]
    public class InitializingMultidimensionalArrayExample
    {
        [TestMethod]
        public void RectangularArrays()
        {
            char[,] boardGameLetter = new char[2, 2];

            boardGameLetter[0, 0] = 'A';
            boardGameLetter[0, 1] = 'B';
            boardGameLetter[1, 0] = 'C';
            boardGameLetter[1, 1] = 'D';
